...
- (NSAttributedString *)descriptionForEmptyDataSet:(UIScrollView *)scrollView {
    ...
    NSAttributedString *attr = [[NSAttributedString alloc] initWithString:self.emptyText attributes:@{NSFontAttributeName: [UIFont systemFontOfSize:15], NSForegroundColorAttributeName: [UIColor colorWithRed:0.588 green:0.588 blue:0.588 alpha:1.00]}];
    return attr;
}
